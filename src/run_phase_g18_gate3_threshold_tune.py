...
def run_gate3_sweet_spot():
    torch.manual_seed(42)
    np.random.seed(42)
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

    # Sub-threshold regime where localized homology dominates
    p_val, eta = 0.0035, 100.0
    shots = 15000

    print("=" * 95)
    print("PHASE G.18: GATE 3 ZERO-SHOT d=11 TRANSFER AT SUB-THRESHOLD p=0.0035")
    print("=" * 95 + "\n")
