...
def run_gate3_gpu_instant():
    ...
    print("=" * 80)
    print("PHASE G.26: GPU UNLEASHED & DATA CALIBRATED")
    print("=" * 80 + "\n")
    ...
    for epoch in range(1, 9):
        ...
        for _ in range(80):
            # Reduced batch size to 32 to prevent GPU OOM on massive full graphs
        ...
        print(f"  Epoch {epoch:d}/8 | Loss: {tot_loss/items:.4f} | Acc: {(correct/items)*100:6.1f}%")
